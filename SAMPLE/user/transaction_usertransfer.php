...
// Assuming the client ID is stored in the session when the client logs in
$client_id = $_SESSION['client_id'] ?? null;

if (!$client_id) {
    // Redirect to login page if the client is not logged in
...
<div class="main-content">
    <h1>iBanking Advanced Reporting : Transfer</h1>
    ...
    <table id="depositTable" class="display nowrap" style="width:100%">
        ...
        <tbody>
            ...
            // SQL query to fetch deposits for the logged-in client
            $sql = "SELECT tr_code, account_number, transaction_amt, acc_name, created_at 
                    FROM transactions 
                    WHERE tr_type = 'Transfer' AND client_id = ?";
            ...
            // Prepare the query and bind the client_id
